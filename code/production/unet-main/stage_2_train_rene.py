...
if __name__ == "__main__":
    ...
    def main():
        ...
        #'accuracy': 0.9482908248901367, 'dice_coef': 0.6712698936462402, 'loss': 0.32215389609336853
        ...
        sgd = SGD(learning_rate=lr, momentum=0.9, nesterov=True)#, weight_decay=wd)#, clipnorm=cn)# clipvalue=cv, weight_decay=wd)
        ...
        while epoch_idx < epochs:
            ...
            if isnan(val_loss_this_epoch) or (val_loss_this_epoch > previous_loss):
                ...
                if tolerance == 2:
                    ...
                    lr_half_count += 1
                    opt = SGD(learning_rate=lr * 0.5**lr_half_count, momentum=0.9 - lr_half_count * 0.02, nesterov=True)#, weight_decay=wd)
                    model.compile(optimizer=opt, loss=loss_cfg, metrics=m, jit_compile=True)
