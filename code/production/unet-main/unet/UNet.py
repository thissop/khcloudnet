from keras import models, layers, regularizers, mixed_precision, initializers

conv_act_default = layers.PReLU
hn_i = initializers.HeNormal
...
def UNet_v2(input_shape, input_label_channel_count:int=1, layer_count=64, regularizers=regularizers.l2(0.0001), weights_file=None, summary=False, countbranch=False):
    ...
    c1 = layers.Conv2D(1 * layer_count, (3, 3), kernel_initializer=hn_i(), padding='same')(pp_in_layer)
    c1 = conv_act_default()(c1)
    c1 = layers.Conv2D(1 * layer_count, (3, 3), kernel_initializer=hn_i(), padding='same')(c1)
    c1 = conv_act_default()(c1)
    n1 = layers.BatchNormalization()(c1)
    p1 = layers.MaxPooling2D()(n1)

    c2 = layers.Conv2D(2 * layer_count, (3, 3), kernel_initializer=hn_i(), padding='same')(p1)
    c2 = conv_act_default()(c2)
    c2 = layers.Conv2D(2 * layer_count, (3, 3), kernel_initializer=hn_i(), padding='same')(c2)
    c2 = conv_act_default()(c2)
    n2 = layers.BatchNormalization()(c2)
    p2 = layers.MaxPooling2D()(n2)

    c3 = layers.Conv2D(4 * layer_count, (3, 3), kernel_initializer=hn_i(), padding='same')(p2)
    c3 = conv_act_default()(c3)
    c3 = layers.Conv2D(4 * layer_count, (3, 3), kernel_initializer=hn_i(), padding='same')(c3)
    c3 = conv_act_default()(c3)
    n3 = layers.BatchNormalization()(c3)
    p3 = layers.MaxPooling2D()(n3)

    c4 = layers.Conv2D(8 * layer_count, (3, 3), kernel_initializer=hn_i(), padding='same')(p3)
    c4 = conv_act_default()(c4)
    c4 = layers.Conv2D(8 * layer_count, (3, 3), kernel_initializer=hn_i(), padding='same')(c4)
    c4 = conv_act_default()(c4)
    n4 = layers.BatchNormalization()(c4)
    p4 = layers.MaxPooling2D()(n4)

    c5 = layers.Conv2D(16 * layer_count, (3, 3), kernel_initializer=hn_i(), padding='same')(p4)
    c5 = conv_act_default()(c5)
    c5 = layers.Conv2D(16 * layer_count, (3, 3), kernel_initializer=hn_i(), padding='same')(c5)
    c5 = conv_act_default()(c5)
    n5 = layers.BatchNormalization()(c5)

    u6 = attention_up_and_concat(n5, n4)
    c6 = layers.Conv2D(8 * layer_count, (3, 3), kernel_initializer=hn_i(), padding='same')(u6)
    c6 = conv_act_default()(c6)
    c6 = layers.Conv2D(8 * layer_count, (3, 3), kernel_initializer=hn_i(), padding='same')(c6)
    c6 = conv_act_default()(c6)
    n6 = layers.BatchNormalization()(c6)

    u7 = attention_up_and_concat(n6, n3)
    c7 = layers.Conv2D(4 * layer_count, (3, 3), kernel_initializer=hn_i(), padding='same')(u7)
    c7 = conv_act_default()(c7)
    c7 = layers.Conv2D(4 * layer_count, (3, 3), kernel_initializer=hn_i(), padding='same')(c7)
    c7 = conv_act_default()(c7)
    n7 = layers.BatchNormalization()(c7)

    u8 = attention_up_and_concat(n7, n2)
    c8 = layers.Conv2D(2 * layer_count, (3, 3), kernel_initializer=hn_i(), padding='same')(u8)
    c8 = conv_act_default()(c8)
    c8 = layers.Conv2D(2 * layer_count, (3, 3), kernel_initializer=hn_i(), padding='same')(c8)
    c8 = conv_act_default()(c8)
    n8 = layers.BatchNormalization()(c8)

    u9 = attention_up_and_concat(n8, n1)
    c9 = layers.Conv2D(1 * layer_count, (3, 3), kernel_initializer=hn_i(), padding='same')(u9)
    c9 = conv_act_default()(c9)
    c9 = layers.Conv2D(1 * layer_count, (3, 3), kernel_initializer=hn_i(), padding='same')(c9)
    c9 = conv_act_default()(c9)
...
def attention_block_2d(x, g, inter_channel):
    theta_x = layers.Conv2D(inter_channel, [1, 1], strides=[1, 1], kernel_initializer=hn_i())(x)
    phi_g = layers.Conv2D(inter_channel, [1, 1], strides=[1, 1], kernel_initializer=hn_i())(g)
    f = conv_act_default()(layers.add([theta_x, phi_g]))
